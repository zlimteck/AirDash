...
private let changelog: [ChangelogEntry] = [
    ChangelogEntry(version: "1.0.12", changes: [
        ...
        "changelog.1_0_12.quick_connect"
    ]),
    ChangelogEntry(version: "1.0.11", changes: [
        "changelog.1_0_11.history_opt_in",
        "changelog.1_0_11.temp_file_privacy",
        "changelog.1_0_11.privacy_policy_in_app",
        "changelog.1_0_11.dashboard_retry"
    ]),
    ChangelogEntry(version: "1.0.10", changes: [
        "changelog.1_0_10.switch_server_fix",
        "changelog.1_0_10.remember_last_device"
    ]),
    ChangelogEntry(version: "1.0.9", changes: [
        "changelog.1_0_9.native_vpn",
        "changelog.1_0_9.dashboard_tunnel_card",
        "changelog.1_0_9.direct_connect",
        "changelog.1_0_9.wireguard_credit"
    ]),
    ChangelogEntry(version: "1.0.8", changes: [
        "changelog.1_0_8.peak_hours",
        "changelog.1_0_8.comparison_history",
        "changelog.1_0_8.reliability_badges",
        "changelog.1_0_8.comparison_bandwidth",
        "changelog.1_0_8.widgets_redesign",
        "changelog.1_0_8.account_widget",
        "changelog.1_0_8.protocol_logos",
        "changelog.1_0_8.trademark_credits"
    ]),
    ...
    ChangelogEntry(version: "1.0.6", changes: [
        ...
        "changelog.1_0_6.siri_shortcuts",
        "changelog.1_0_6.favorite_badge",
        "changelog.1_0_6.per_account_prefs",
        "changelog.1_0_6.security",
        "changelog.1_0_6.widget_flags"
    ]),
